...
- `Backend/.github/workflows/e2e_tests_pull_request.yml` runs this scenario for Taski, Exesh, scenario, workflow, and filestorage-submodule-pointer changes. It is independent of the component workflows and does not gate their build or deploy jobs.
